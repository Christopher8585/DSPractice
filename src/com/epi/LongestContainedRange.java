...
public class LongestContainedRange {
  ...
  public static void main(String[] args) {
    ...
    for (int times = 0; times < 1; ++times) {
      ...
      System.out.println();
      System.out.println(findLongestContainedRangeInt(A));
      Pair<Integer, Integer> result = findLongestContainedRange(A);
      System.out.println(result);
      System.out.println(checkAns(A));
      //System.out.println (result.getSecond() - result.getFirst() + 1 == findLongestContainedRangeInt(A));
      //System.out.println (result.getSecond() - result.getFirst() + 1 == longestContainedRange(A));
    }
  }
}
