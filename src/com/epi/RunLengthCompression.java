...
public class RunLengthCompression {
	...
	public static void main(String[] args) {
		...
		System.out.println("4a1b3c2a".equals(encoding("aaaabcccaa")));
		System.out.println("eeeffffee".equals(decoding("3e4f2e")));
		System.out.println("aaaaaaaaaaffffee".equals(decoding("10a4f2e")));
	}
}
