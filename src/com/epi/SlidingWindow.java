...
public class SlidingWindow {
	...
	public static List<TrafficElement> computeTrafficVolumes(
		...
		for (TrafficElement trafficInfo : A) {
			...
			maximumVolumes.add(new TrafficElement(trafficInfo.time,
	...
	public static void main(String[] args) {
		...
		TrafficElement[] A = new TrafficElement[] { new TrafficElement(0, 1.3),
				new TrafficElement(2, 2.5), new TrafficElement(3, 3.7),
				new TrafficElement(5, 1.4), new TrafficElement(6, 2.6),
				new TrafficElement(8, 2.2), new TrafficElement(9, 1.7),
		...
		List<TrafficElement> golden = Arrays.asList(new TrafficElement(0, 1.3),
				new TrafficElement(2, 2.5), new TrafficElement(3, 3.7),
				new TrafficElement(5, 3.7), new TrafficElement(6, 3.7),
				new TrafficElement(8, 2.6), new TrafficElement(9, 2.6),
				new TrafficElement(14, 1.1));
